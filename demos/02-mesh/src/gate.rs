...
fn meta(seed: u64) -> ReplayMeta {
    ReplayMeta {
        ...
        // A generated stream was laid out for no surface and on no monitor, and
        // this one drives no UI: zero is the same "the file does not say" an
        // older file decodes to.
        surface: (0, 0),
        dpi: 0,
    }
}
