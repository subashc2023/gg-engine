...
fn main() {
    ...
    let scattered_native = measure_n("native chunk loop", scattered_n, || {
    ...
    let scattered_views = measure_n("column views", scattered_n, || {
    ...
    let scattered_typed = measure_n("typed each()", scattered_n, || {
